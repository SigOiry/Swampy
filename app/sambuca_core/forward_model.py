...
def forward_model(
    ...
    # Mean bottom attenuation factor across bands: fraction of substrate reflectance
    # that survives the two-way water column path. Independent of NEDR, purely physical.
    # Near 1.0 = very shallow/clear; near 0.0 = bottom signal completely attenuated.
    exp_bottom = float(np.mean(expBottomScaled))
